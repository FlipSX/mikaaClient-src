...
public class UIRender {
   ...
   public static void a(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8) {
      ...
      ali2.pos((double)f, (double)(f2 + f6), 0.0D).tex((double)(f3 * f9), (double)((f4 + f6) * f10)).endVertex();
      ali2.pos((double)(f + f5), (double)(f2 + f6), 0.0D).tex((double)((f3 + f5) * f9), (double)((f4 + f6) * f10)).endVertex();
      ali2.pos((double)(f + f5), (double)f2, 0.0D).tex((double)((f3 + f5) * f9), (double)(f4 * f10)).endVertex();
      ali2.pos((double)f, (double)f2, 0.0D).tex((double)(f3 * f9), (double)(f4 * f10)).endVertex();
      bly2.draw();
   }
